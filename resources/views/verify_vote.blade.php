...
<div class="login-wrap" style="max-width:800px;">
    ...
    <h1 class="text-center ">Cast Vote</h1>
    <p style="color:white;">We have sent an SMS code to your Mobile#. Please verify it to Cast Vote.</p>
    <form method="POST" action="verify_vote">
